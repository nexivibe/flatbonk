...
public class LevelUpDialog {
    ...
    public LevelUpDialog(Stage stage, GameState gameState, Runnable onSelect) {
        this.stage = stage;
    ...
    private void selectPowerup(Powerup powerup) {
        // Apply powerup to player (need to get player from somewhere)
        // For now, just level up the powerup
        powerup.levelUp();
